...
export default function SearchBar(){
    ...
    return (
        <div className="search-bar">
            <form>
                <CSSTransition nodeRef={searchBoxRef} in={isExpanded} timeout={250} classNames="input-search-bar">
                    <input ref={searchBoxRef} type="search" placeholder="      Search..."/>
                </CSSTransition>
            </form>
            <CSSTransition nodeRef={inputButtonRef} in={isExpanded} timeout={250} classNames="search-button">
                <button ref={inputButtonRef} name="open-search" onClick={expandSearchField}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.75em" viewBox="0 -960 960 960" width="1.75em"
                         fill={isExpanded ? "darkslategray" : "lightgray"}>
                        <path
